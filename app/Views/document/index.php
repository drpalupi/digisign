...
<div class="container-fluid">
    ...
    <div class="row mt-3">
            ...
            <tbody>
                ...
                foreach ($documents as $document) : ?>
                    ...
                    <tr>
                        ...
                        <td><a target="_blank" download="<?= $document['qrcode_hash'] . '.cer' ?>" href="<?= base_url() ?>/uploads/certificate/<?= $document['qrcode_hash'] . '.cer' ?>"><span class="badge badge-pill badge-primary">Download</span></a></td>
                        <td>
        ...
        <?= $pager->links('documents', 'document_pagination') ?>
    </div>
</div>
