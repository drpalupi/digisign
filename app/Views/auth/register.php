                        ...
                        <div class="p-5">
                            ...
                            <form action="<?= route_to('register') ?>" method="post" class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" id="username" name="username" placeholder="Nomor Identitas" value="<?= old('id_number') ?>">
                                </div>
                                <div class="form-group">
