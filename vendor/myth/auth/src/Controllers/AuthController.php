...
class AuthController extends Controller
{
	...
	public function attemptRegister()
	{
		...
		$rules = [
			...
			'username' => 'required|numeric|is_unique[users.username]'
		];
		...
		$user = new User(array_merge($this->request->getPost($allowedPostFields), array('private_key' => $private, 'public_key' => $public)));
